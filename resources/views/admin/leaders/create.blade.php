...
@section('page-title', 'Create Leader')
...
<div class="section-gap">
    <div class="card p-4">
        <h6 class="mb-3 heading">New Leader</h6>
        <form id="leader-create-form">
            <div class="row g-3">
                <div class="col-md-6">
...
<script>
    ...
    document.getElementById('leader-create-form').addEventListener('submit', async function (e) {
        e.preventDefault();
        const form = e.target;
        const payload = {
        ...
        await AdminApp.apiPost('/api/v1/leaders', payload);
