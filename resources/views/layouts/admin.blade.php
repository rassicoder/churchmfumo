...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - Church Association Leadership & Activities Management System</title>
    ...
    <div class="offcanvas-lg offcanvas-start sidebar" tabindex="-1" id="adminSidebar">
        ...
        <div class="offcanvas-body">
            <nav class="nav flex-column gap-1">
                ...
                <a class="nav-link {{ request()->routeIs('admin.churches') ? 'active' : '' }}" href="{{ route('admin.churches') }}">
                    <i class="bi bi-buildings"></i> Churches
                </a>
                <a class="nav-link {{ request()->routeIs('admin.leaders') ? 'active' : '' }}" href="{{ route('admin.leaders') }}">
                ...
                <a class="nav-link {{ request()->routeIs('admin.meetings') ? 'active' : '' }}" href="{{ route('admin.meetings') }}">
    ...
    <main class="flex-grow-1">
        <div class="content-wrapper">
            <nav class="navbar topbar px-3 mb-4">
                ...
                <div class="ms-2 page-title">@yield('page-title', 'Dashboard')</div>
